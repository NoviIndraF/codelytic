        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-valide mt-24" action="/dashboard/tasks" method="post">
                        @csrf
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label" for="title">Judul Tugas <span class="text-danger">*</span>
                            </label>
                            <div class="col-lg-8">
                                <input type="text" class="form-control input-default" id="title" name="title" placeholder="Masukkan Judul Tugas..." required value="{{ old('title') }}">
                                @error('title')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input type="text" class="form-control datepicker" id="deadline" name="deadline" placeholder="Tanggal Batas Pengumpulan..." value="{{ old('deadline') }}"> <span class="input-group-append"><span class="input-group-text"><i class="mdi mdi-calendar-check"></i></span></span>
                                    @error('deadline')
                                    <h6 class="text-danger">* 
                                        {{ $message }}
                                    </h6>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control input-default" id="description" name="description" placeholder="Deskripsi Tugas..." value="{{ old('description') }}">
                                @error('description')
                                    <h6 class="text-danger">* 
                                        {{ $message }}
                                    </h6>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control input-default" id="note" name="note" placeholder="Catatan Tugas..." value="{{ old('note') }}">
                                @error('note')
                                    <h6 class="text-danger">* 
                                        {{ $message }}
                                    </h6>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3">
                                <button class="btn login-form__btn submit" type="submit">Tambah Tugas</button>
                            </div>
                        </div>
                    </form>
                </div>
